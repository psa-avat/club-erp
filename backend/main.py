...
from api.routes import auth, admin, members, accounting, assets, carburant, carburant_public, cheque_remittance, flights, flight_packs, federal_sync, gesasso, helloasso, hr, member_portal, planche, reconciliation, storage, vi
...
app.include_router(cheque_remittance.router)
...
app.include_router(carburant_public.router)
