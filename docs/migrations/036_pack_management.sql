...
COMMENT ON COLUMN pack_definitions.pack_sales_account_uuid IS 'Credit account for pack purchase revenue (overrides default)';
COMMENT ON COLUMN pack_definitions.rem_discount_account_uuid IS 'Debit account for REM discount adjustments (overrides default)';
